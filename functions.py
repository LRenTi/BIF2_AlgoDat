...
def menuText():
    ...
    print("3 - IMPORT: Kurswerte für eine Aktie werden aus einer csv Datei importiert.")
    print("4 - SEARCH: Eine Aktie wird in der Hashtabelle gesucht")
    print("5 - PLOT: Die Schlusskurve der letzten 30 Tage einer Aktie werden als Grafik ausgegeben")
