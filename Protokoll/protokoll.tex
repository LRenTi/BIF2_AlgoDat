...
eine Rotation nach links wird ausgeführt. Genau umgekehrt wird eine Rotation nach rechts ausgeführt, wenn der Balance-Faktor kleiner als -1 ist. Bei der Funktion \texttt{_insert(self, node, key)} wird nach dem Einfügen eines neuen Knotens der Baum balanciert, indem die Funktion \texttt{return balance(self, node)} ausgibt. Diese Funktion überprüft den Balance-Faktor des Knotens und führt gegebenenfalls eine Rotation aus.
Wenn man dies nicht möchte kann 
\begin{itemize}
